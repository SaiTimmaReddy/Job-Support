    ...
    return (
        <Drawer variant="permanent" open={open}>
            ...
            <List>
                ...
                <ListItem sx={activeClass('/interviews')} button onClick={() => history.push('/interviews')}>
                    <ListItemIcon>
                        <PortraitIcon />
                    </ListItemIcon>
                    <ListItemText primary="Interviews" />
                </ListItem>
                <ListItem sx={activeClass('/students')} button onClick={() => history.push('/students')}>
                    <ListItemIcon>
                        <PeopleIcon />
                    </ListItemIcon>
                ...
                <ListItem
                    sx={activeClass('/partner_applications')}
                    button
                    onClick={() => history.push('/partner_applications')}
                >
                    <ListItemIcon>
                        <ArticleIcon />
                    </ListItemIcon>
                    <ListItemText primary="Partner Application" />
                </ListItem>
            </List>
        </Drawer>
    );
