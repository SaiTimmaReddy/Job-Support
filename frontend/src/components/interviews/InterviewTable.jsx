...
export default function InterviewTable(props) {
    const { interviews, page, handlePageChange, isLoading, showPagination, showEdit } = props;
                        ...
                        <TableBody>
                            {interviews.results.map(interview => (
                                <StyledTableRow key={interview.id}>
                                    ...
                                    <StyledTableCell align="center">
                                        {interview.updated_by && interview.updated_by.user_name}
                                        <br />
                                    </StyledTableCell>
                                    <StyledTableCell align="center">
                                        {interview.created_by && interview.created_by.user_name}
                                        <br />
                                    </StyledTableCell>
                                    {showEdit &&
                                    <StyledTableCell align="center">
